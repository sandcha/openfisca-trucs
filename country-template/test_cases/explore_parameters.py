...
# before december 2016, the housing allowance amont is > 0
simulation.set_input("rent", "2011-01", numpy.array([0, 500, 1000]))
...
# from # before december 2016, the housing allowance amont is 0
